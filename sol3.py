wstr = '''kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
for i in range(4, n - 4):
	if ord(wstr[i])>=97 and ord(wstr[i])<=122:
		if ord(wstr[i-1])>=65 and ord(wstr[i-1])<=90 and ord(wstr[i-2])>=65 and ord(wstr[i-2])<=90 and ord(wstr[i-3])>=65 and ord(wstr[i-3])<=90 and ord(wstr[i+1])>=65 and ord(wstr[i+1])<=90 and ord(wstr[i+2])>=65 and ord(wstr[i+2])<=90 and ord(wstr[i+3])>=65 and ord(wstr[i+3])<=90:
			if ord(wstr[i+4])>=97 and ord(wstr[i+4])<=122 and ord(wstr[i-4])>=97 and ord(wstr[i-4])<=122:
				ans = ans + wstr[i]
